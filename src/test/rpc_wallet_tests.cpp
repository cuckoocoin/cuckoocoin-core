...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CCuckoocoinAddress demoAddress = CCuckoocoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CCuckoocoinAddress setaccountDemoAddress = CCuckoocoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CCuckoocoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CCuckoocoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
