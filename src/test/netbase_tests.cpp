...
{
    BOOST_CHECK(TestSplitHost("www.cuckoocoin.org", "www.cuckoocoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.cuckoocoin.org]", "www.cuckoocoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.cuckoocoin.org:80", "www.cuckoocoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.cuckoocoin.org]:80", "www.cuckoocoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:27333", "127.0.0.1", 27333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:27333", "127.0.0.1", 27333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:27333", "::ffff:127.0.0.1", 27333));
    BOOST_CHECK(TestSplitHost("[::]:27333", "::", 27333));
    BOOST_CHECK(TestSplitHost("::27333", "::27333", -1));
    BOOST_CHECK(TestSplitHost(":27333", "", 27333));
    BOOST_CHECK(TestSplitHost("[]:27333", "", 27333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:27333", "127.0.0.1:27333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:27333", "[::]:27333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
