...
#ifndef CUCKOOCOIN_RPCPROTOCOL_H
#define CUCKOOCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Cuckoocoin is not connected
...
#endif // CUCKOOCOIN_RPCPROTOCOL_H
