...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Cuckoocoin Core cuckoocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cuckoocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cuckoocoin transaction") + "\n" +
              "  cuckoocoin-tx [options] -create [commands]   " + _("Create hex-encoded cuckoocoin transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutAddr(CMutableTransaction& tx, const string& strInput)
{
    ...
    CCuckoocoinAddress addr(strAddr);
    if (!addr.IsValid())
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cuckoocoin transaction
