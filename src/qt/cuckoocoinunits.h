...
#ifndef CUCKOOCOIN_QT_CUCKOOCOINUNITS_H
#define CUCKOOCOIN_QT_CUCKOOCOINUNITS_H
...
/** Cuckoocoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CuckoocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CuckoocoinUnits(QObject *parent);

    /** Cuckoocoin units.
      @note Source: https://en.cuckoocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CUC,
...
typedef CuckoocoinUnits::Unit CuckoocoinUnit;

#endif // CUCKOOCOIN_QT_CUCKOOCOINUNITS_H
