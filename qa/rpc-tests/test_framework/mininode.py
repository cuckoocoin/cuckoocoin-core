# mininode.py - Cuckoocoin P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a cuckoocoin node
# NodeConnCB: a base class that describes the interface for receiving
#             callbacks with network messages from a NodeConn
# CBlock, CTransaction, CBlockHeader, CTxIn, CTxOut, etc....:
#     data structures that should map to corresponding structures in
#     cuckoocoin/primitives
...
# Objects that map to cuckoocoind objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in cuckoocoind indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest"):
        ...
        print 'MiniNode: Connecting to Cuckoocoin Node IP # ' + dstaddr + ':' \
            + str(dstport)
