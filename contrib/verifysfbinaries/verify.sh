...
###   This script attempts to download the signature file SHA256SUMS.asc from cuckoocoin.org
...
WORKINGDIR="/tmp/cuckoocoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://cuckoocoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://cuckoocoin.org/bin/"
VERSIONPREFIX="cuckoocoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'cuckoocoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[cuckoocoin-]<version>-[rc[0-9]] (example: cuckoocoin-0.9.2-rc1)"
   echo "wget output:"
